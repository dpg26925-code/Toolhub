...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nexatools — The Ultimate AI-Powered Online Tool Platform" },
      { name: "description", content: "Free and Pro online tools for PDF, image, AI, and developer workflows. Fast, private, and built for global creators." },
      { name: "author", content: "Nexatools" },
      { property: "og:title", content: "Nexatools — The Ultimate AI-Powered Online Tool Platform" },
      ...
      { property: "og:site_name", content: "Nexatools" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@nexatools" },
      { name: "twitter:title", content: "Nexatools — The Ultimate AI-Powered Online Tool Platform" },
    ...
    scripts: [
      {
        async: true,
        src: "https://www.googletagmanager.com/gtag/js?id=G-E57495G278",
      },
      {
