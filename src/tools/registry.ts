...
export const TOOL_REGISTRY: Record<string, LazyExoticComponent<ComponentType>> = import.meta.env.SSR ? {} : {
  ...
  "passport-photo-maker": lazy(() => import("./passport-photo-maker")),
  "passport-photo": lazy(() => import("./passport-photo-maker")),
  "prepare-passport-photo": lazy(() => import("./passport-photo-maker")),
...
Object.assign(TOOL_REGISTRY, import.meta.env.SSR ? {} : {
  ...
  // New Money-Making Tools (Affiliate, E-Commerce, Creator Economy)
  "amazon-affiliate-link-generator": lazy(() => import("./amazon-affiliate-link-generator")),
  "commission-calculator-pro": lazy(() => import("./commission-calculator-pro")),
  "coupon-code-generator": lazy(() => import("./coupon-code-generator")),
  "shopify-profit-calculator": lazy(() => import("./shopify-profit-calculator")),
  "ebay-fee-calculator": lazy(() => import("./ebay-fee-calculator")),
  "amazon-fba-calculator": lazy(() => import("./amazon-fba-calculator")),
  "youtube-money-calculator": lazy(() => import("./youtube-money-calculator")),
  "instagram-engagement-rate-calculator": lazy(() => import("./instagram-engagement-rate-calculator")),
  "sponsorship-rate-calculator": lazy(() => import("./sponsorship-rate-calculator")),
  "freelance-rate-calculator": lazy(() => import("./freelance-rate-calculator")),
  "tiktok-shop-fee-calculator": lazy(() => import("./tiktok-shop-fee-calculator")),
  "crypto-profit-calculator": lazy(() => import("./crypto-profit-calculator")),
  "dropshipping-calculator": lazy(() => import("./dropshipping-calculator")),
  "dropshipping-product-research": lazy(() => import("./dropshipping-calculator")),
  "stock-profit-calculator": lazy(() => import("./stock-profit-calculator")),
  "stock-market-profit-calculator": lazy(() => import("./stock-profit-calculator")),
});
