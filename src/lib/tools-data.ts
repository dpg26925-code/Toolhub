...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    shortDescription: "Calcule margem bruta, líquida e markup dos seus produtos de e-commerce.",
    categorySlug: "accounting",
    icon: "📈",
    isFree: true,
    creditCost: 0,
  ...
  {
    slug: "calculadora-frete-gratis",
    name: "Calculadora de Frete Grátis",
    shortDescription: "Descubra o preço mínimo para oferecer frete grátis sem perder lucro.",
    categorySlug: "accounting",
    icon: "🚚",
    isFree: true,
    creditCost: 0,
  ...
  {
    slug: "calculadora-cupom-desconto",
    name: "Calculadora de Cupom de Desconto",
    shortDescription: "Simule descontos e veja o impacto real na sua margem de lucro.",
    categorySlug: "accounting",
    icon: "🎟️",
    isFree: true,
    creditCost: 0,
  ...
  },
  {
    ...
    shortDescription: "Saiba quantas unidades você precisa vender para cobrir todos os seus custos.",
    categorySlug: "accounting",
    icon: "⚖️",
    isFree: true,
    creditCost: 0,
  ...
  },
  {
    ...
    shortDescription: "Calcule o retorno sobre investimento (ROI) e ROAS das suas campanhas de anúncios.",
    categorySlug: "accounting",
    icon: "🎯",
    isFree: true,
    creditCost: 0,
  ...
  },
  {
    ...
    name: "Calculadora de Estoque Mínimo",
    shortDescription: "Calcule o ponto de reposição e estoque de segurança para evitar falta de produtos.",
    categorySlug: "accounting",
    icon: "📦",
    isFree: true,
    creditCost: 0,
  ...
  },
  {
    ...
    shortDescription: "Sugestão de preço de venda baseado em custos, taxas e margem desejada.",
    categorySlug: "accounting",
    icon: "💰",
    isFree: true,
    creditCost: 0,
...
const BATCHES_29_37 = [
  ...
  { slug: "forex-pivot-points-calculator", name: 'Forex Pivot Points Calculator', shortDescription: 'Classical pivot with R1-R3 and S1-S3.', categorySlug: "trader", icon: "🎯", isFree: true, creditCost: 0, clientSide: true },
  {
    ...
    shortDescription: "Estimate your monthly Pag-IBIG Fund contributions for 2024.",
    categorySlug: "accounting",
    icon: "🏠",
    isFree: true,
    creditCost: 0,
  ...
  },
  {
    ...
    shortDescription: "Calculate your monthly SSS contributions based on 2024 schedules.",
    categorySlug: "accounting",
    icon: "💳",
    isFree: true,
    creditCost: 0,
  ...
  {
    slug: "philhealth-calculator",
    name: "PhilHealth Calculator",
    shortDescription: "Estimate monthly PhilHealth premiums based on 2024 rates.",
    categorySlug: "accounting",
    icon: "🏥",
    isFree: true,
    creditCost: 0,
  ...
  {
    slug: "bir-withholding-tax-calculator",
    name: "BIR Withholding Tax Calculator",
    shortDescription: "Estimate your monthly withholding tax using 2024 BIR tax tables.",
    categorySlug: "accounting",
    icon: "📊",
    isFree: true,
    creditCost: 0,
  ...
  {
    slug: "overtime-calculator-philippines",
    name: "Philippines Overtime Calculator",
    shortDescription: "Calculate overtime pay based on Philippine labor law rates.",
    categorySlug: "accounting",
    icon: "⏰",
    isFree: true,
    creditCost: 0,
  ...
  {
    slug: "holiday-pay-calculator-ph",
    name: "Holiday Pay Calculator Philippines",
    shortDescription: "Compute holiday pay for regular and special non-working days.",
    categorySlug: "accounting",
    icon: "📅",
    isFree: true,
    creditCost: 0,
  ...
  },
  {
    ...
    name: "Night Shift Differential Calculator",
    shortDescription: "Calculate 10% night shift differential for work between 10PM and 6AM.",
    categorySlug: "accounting",
    icon: "🌙",
    isFree: true,
    creditCost: 0,
  ...
  {
    slug: "amazon-affiliate-link-generator",
    name: "Amazon Affiliate Link Generator",
    shortDescription: "Generate compliant Amazon Associates tracking links with custom tags, channels, and QR codes.",
    categorySlug: "affiliate",
    icon: "🔗",
    isFree: true,
    creditCost: 0,
  ...
  {
    slug: "commission-calculator-pro",
    name: "Commission Calculator Pro",
    shortDescription: "Calculate affiliate, sales, and tiered commission earnings with multi-tier brackets and projections.",
    categorySlug: "affiliate",
    icon: "💰",
    isFree: true,
    creditCost: 0,
  ...
  },
  {
    ...
    shortDescription: "Generate cryptographically unique promo and coupon codes in bulk for marketing and e-commerce.",
    categorySlug: "affiliate",
    icon: "🎟️",
    isFree: true,
    creditCost: 0,
  ...
  },
  {
    ...
    shortDescription: "Calculate net profit margins, payment gateway deductions, CAC ad spend, and break-even sales for Shopify.",
    categorySlug: "accounting",
    icon: "🛍️",
    isFree: true,
    creditCost: 0,
  ...
  },
  {
    ...
    shortDescription: "Calculate eBay final value fees, managed payments, promoted listing ad costs, and net seller profit.",
    categorySlug: "accounting",
    icon: "🏷️",
    isFree: true,
    creditCost: 0,
  ...
  },
  {
    ...
    shortDescription: "Estimate Amazon FBA fulfillment fees, referral fees, monthly storage, and net profit margins.",
    categorySlug: "accounting",
    icon: "📦",
    isFree: true,
    creditCost: 0,
  ...
  },
  {
    ...
    shortDescription: "Estimate YouTube channel ad earnings, RPM, and sponsorship income based on daily views and niche CPM.",
    categorySlug: "youtube",
    icon: "▶️",
    isFree: true,
    creditCost: 0,
  ...
  },
  {
    ...
    shortDescription: "Calculate Instagram engagement rate, quality score, follower benchmarks, and suggested sponsorship rates.",
    categorySlug: "social",
    icon: "📸",
    isFree: true,
    creditCost: 0,
  ...
  },
  {
    ...
    shortDescription: "Calculate suggested sponsorship pricing and package bundles for YouTube, Instagram, TikTok, and podcasts.",
    categorySlug: "social",
    icon: "🤝",
    isFree: true,
    creditCost: 0,
  ...
  },
  {
    ...
    shortDescription: "Calculate hourly, day, and monthly retainer rates based on target take-home salary, taxes, and expenses.",
    categorySlug: "accounting",
    icon: "💼",
    isFree: true,
    creditCost: 0,
  ...
  },
  {
    ...
    shortDescription: "Calculate TikTok Shop marketplace commissions, transaction fees, creator affiliate cuts, and net profits across Brazil, Philippines, US, UK, and SE Asia.",
    categorySlug: "tiktok",
    icon: "🎵",
    isFree: true,
    creditCost: 0,
  ...
  },
  {
    ...
    shortDescription: "Calculate cryptocurrency profit, loss, ROI percentage, exchange trading fees, and capital gains taxes for Bitcoin, Ethereum, and altcoins.",
    categorySlug: "trader",
    icon: "🪙",
    isFree: true,
    creditCost: 0,
  ...
  },
  {
    ...
    name: "Dropshipping Product Research Calculator",
    shortDescription: "Calculate dropshipping product profit margins, ad CAC costs, break-even ROAS, and overall Product Viability Score (1–100).",
    categorySlug: "accounting",
    icon: "🔍",
    isFree: true,
    creditCost: 0,
  ...
  },
  {
    ...
    name: "Stock Market Profit Calculator",
    shortDescription: "Calculate stock trading profits, broker commissions, capital gains tax, margin leverage costs, and break-even exit prices.",
    categorySlug: "trader",
    icon: "📈",
    isFree: true,
    creditCost: 0,
